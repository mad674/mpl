...
const imageSets=["/images1.jpeg","/images2.jpeg", "/images3.jpeg", "/images4.jpeg", "/images5.jpeg", "/images6.jpeg","/images6.jpeg","/images5.jpeg", "/images4.jpeg", "/images3.jpeg", "/images2.jpeg","/images1.jpeg"];
function App() {
  ...
  useEffect(() => {
    let l=generateUniqueRandomNumbers(1,12,12);
    console.log(l);
    let f=[];
  ...
  return(
    <div class="screen">
      <h1><u><b style={{color: '#FF5733 ', font: '3em sans-serif'}}>Match the Pair's</b></u></h1>
      <h2 id="i" style={{color: 'blue', font: '2em'}}>{message}</h2>
      <div className="container">
        {board.map((box, index) => (
          <button key={index} className="box screen" onClick={() => handleBoxClick(index)}>
            {box && <img src={box} alt="" height="280px" width="280px" style={{ backgroundColor: 'white' }} />}
          </button>
        ))}
      </div>
